...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright EmilFekete, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/ClipDistortion-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ClipDistortion-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ClipDistortion-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ClipDistortion-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ClipDistortion-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ClipDistortion-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/ClipDistortion-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/ClipDistortion.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/ClipDistortion.iss",inplace=1):
